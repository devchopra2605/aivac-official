    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <Logo />
              <h2 className="ml-2 text-xl font-bold">AIVAC</h2>
            </div>
            <p className="text-gray-400 mb-4">
              Your Smart AI HVAC System - Experience the future of intelligent climate control
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>GB Pant Govt Engineering College, Delhi</li>
              <li>Email: chopradev399@gmail.com</li>
              <li>Phone: +91 9625132604</li>
            </ul>
            <div className="mt-6">
              <a 
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {year} AIVAC - Powered by Bluestar India. All rights reserved.</p>
